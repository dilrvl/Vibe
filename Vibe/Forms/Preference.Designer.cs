namespace Vibe.Forms
{
    partial class Preference
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblGenres.Font = new Font("Arial", 13.8F, FontStyle.Bold, GraphicsUnit.Point, 204);
            lblGenres.ForeColor = SystemColors.ButtonHighlight;
            lblGenres.Location = new Point(440, 21);
            lblGenres.Name = "lblGenres";
            lblGenres.Size = new Size(331, 27);
            lblGenres.TabIndex = 0;
            lblGenres.Text = "Выберите любимые жанры";
            // 
            // lblTitle
            // 
            ...
            lblTitle.Font = new Font("Arial Narrow", 10.2F, FontStyle.Bold, GraphicsUnit.Point, 204);
            lblTitle.ForeColor = SystemColors.ActiveBorder;
            lblTitle.Location = new Point(403, 61);
            lblTitle.Name = "lblTitle";
            lblTitle.Size = new Size(424, 22);
            lblTitle.TabIndex = 1;
            lblTitle.Text = "Это поможет сделать рекомендации точнее и интереснее.";
            // 
            // panelGenres
            // 
            panelGenres.Anchor = AnchorStyles.None;
            panelGenres.BackColor = Color.Transparent;
            panelGenres.Controls.Add(labelAlternative);
            panelGenres.Controls.Add(labelMetal);
            panelGenres.Controls.Add(labelElectronic);
            panelGenres.Controls.Add(labelRock);
            panelGenres.Controls.Add(pictureBoxAlternativ);
            panelGenres.Controls.Add(pictureBoxMetal);
            panelGenres.Controls.Add(pictureBoxElectronic);
            panelGenres.Controls.Add(pictureBoxRock);
            panelGenres.Controls.Add(labelWorld);
            panelGenres.Controls.Add(labelRapHipHop);
            panelGenres.Controls.Add(labelIndi);
            panelGenres.Controls.Add(labelRap);
            panelGenres.Controls.Add(pictureBoxWorld);
            panelGenres.Controls.Add(pictureBoxRapHipHop);
            panelGenres.Controls.Add(pictureBoxIndi);
            panelGenres.Controls.Add(pictureBoxInRap);
            panelGenres.Controls.Add(labelPop);
            panelGenres.Controls.Add(pictureBoxPop);
            panelGenres.Location = new Point(130, 101);
            ...
            // labelMetal
            // 
            labelMetal.AutoSize = true;
            labelMetal.Font = new Font("Arial Narrow", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
            labelMetal.ForeColor = SystemColors.ButtonHighlight;
            labelMetal.Location = new Point(550, 234);
            labelMetal.Name = "labelMetal";
            labelMetal.Size = new Size(48, 20);
            ...
            label1.Location = new Point(422, 370);
            label1.Name = "label1";
            label1.Size = new Size(415, 27);
            label1.TabIndex = 3;
            label1.Text = "Выберите любимых исполнителей";
            // 
            // label2
            // 
            ...
            label2.Font = new Font("Arial Narrow", 10.2F, FontStyle.Bold, GraphicsUnit.Point, 204);
            label2.ForeColor = SystemColors.ActiveBorder;
            label2.Location = new Point(526, 406);
            label2.Name = "label2";
            label2.Size = new Size(211, 22);
            label2.TabIndex = 4;
            label2.Text = "Помогите лучше узнать вас.";
            // 
            // checkedListBoxArtist
            // 
            checkedListBoxArtist.Anchor = AnchorStyles.None;
            checkedListBoxArtist.BackColor = Color.LightGray;
            checkedListBoxArtist.BorderStyle = BorderStyle.None;
            checkedListBoxArtist.FormattingEnabled = true;
            checkedListBoxArtist.Location = new Point(337, 440);
            checkedListBoxArtist.Name = "checkedListBoxArtist";
            checkedListBoxArtist.Size = new Size(595, 154);
            checkedListBoxArtist.TabIndex = 5;
            // 
            // buttonRegistration
            // 
            buttonRegistration.Anchor = AnchorStyles.None;
            buttonRegistration.BackColor = Color.Gold;
            buttonRegistration.FlatStyle = FlatStyle.Flat;
            buttonRegistration.Font = new Font("Arial", 9F, FontStyle.Bold, GraphicsUnit.Point, 204);
            buttonRegistration.Location = new Point(551, 609);
            buttonRegistration.Name = "buttonRegistration";
            buttonRegistration.Size = new Size(177, 41);
            ...
            Controls.Add(checkedListBoxArtist);
            Controls.Add(label2);
            Controls.Add(label1);
            Controls.Add(panelGenres);
        ...
        private Panel panelGenres;
        private PictureBox pictureBoxWorld;
        private PictureBox pictureBoxRapHipHop;
        private PictureBox pictureBoxIndi;
        private PictureBox pictureBoxInRap;
        private Label labelPop;
        private PictureBox pictureBoxPop;
        private Label labelAlternative;
        private Label labelMetal;
        private Label labelElectronic;
        private Label labelRock;
        private PictureBox pictureBoxAlternativ;
        private PictureBox pictureBoxMetal;
        private PictureBox pictureBoxElectronic;
        private PictureBox pictureBoxRock;
        private Label labelWorld;
        private Label labelRapHipHop;
        private Label labelIndi;
        private Label labelRap;
        private Label label1;
        private Label label2;
        private CheckedListBox checkedListBoxArtist;
